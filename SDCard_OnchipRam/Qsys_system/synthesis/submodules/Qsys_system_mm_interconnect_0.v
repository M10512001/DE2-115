...
module Qsys_system_mm_interconnect_0 (
		...
		input  wire [19:0] nios2_gen2_data_master_address,               //                 nios2_gen2_data_master.address
		...
		input  wire [19:0] nios2_gen2_instruction_master_address,        //          nios2_gen2_instruction_master.address
	...
	wire  [19:0] nios2_gen2_data_master_translator_avalon_universal_master_0_address;              // nios2_gen2_data_master_translator:uav_address -> nios2_gen2_data_master_agent:av_address
	...
	wire  [19:0] nios2_gen2_instruction_master_translator_avalon_universal_master_0_address;       // nios2_gen2_instruction_master_translator:uav_address -> nios2_gen2_instruction_master_agent:av_address
	...
	wire  [19:0] sd_card_avalon_sdcard_slave_agent_m0_address;                                     // sd_card_avalon_sdcard_slave_agent:m0_address -> sd_card_avalon_sdcard_slave_translator:uav_address
	...
	wire  [96:0] sd_card_avalon_sdcard_slave_agent_rf_source_data;                                 // sd_card_avalon_sdcard_slave_agent:rf_source_data -> sd_card_avalon_sdcard_slave_agent_rsp_fifo:in_data
	...
	wire  [96:0] sd_card_avalon_sdcard_slave_agent_rsp_fifo_out_data;                              // sd_card_avalon_sdcard_slave_agent_rsp_fifo:out_data -> sd_card_avalon_sdcard_slave_agent:rf_sink_data
	...
	wire  [95:0] cmd_mux_001_src_data;                                                             // cmd_mux_001:src_data -> sd_card_avalon_sdcard_slave_agent:cp_data
	wire         cmd_mux_001_src_ready;                                                            // sd_card_avalon_sdcard_slave_agent:cp_ready -> cmd_mux_001:src_ready
	wire   [5:0] cmd_mux_001_src_channel;                                                          // cmd_mux_001:src_channel -> sd_card_avalon_sdcard_slave_agent:cp_channel
	...
	wire  [95:0] cmd_mux_002_src_data;                                                             // cmd_mux_002:src_data -> sysid_control_slave_agent:cp_data
	...
	wire  [19:0] nios2_gen2_debug_mem_slave_agent_m0_address;                                      // nios2_gen2_debug_mem_slave_agent:m0_address -> nios2_gen2_debug_mem_slave_translator:uav_address
	...
	wire  [96:0] nios2_gen2_debug_mem_slave_agent_rf_source_data;                                  // nios2_gen2_debug_mem_slave_agent:rf_source_data -> nios2_gen2_debug_mem_slave_agent_rsp_fifo:in_data
	...
	wire  [96:0] nios2_gen2_debug_mem_slave_agent_rsp_fifo_out_data;                               // nios2_gen2_debug_mem_slave_agent_rsp_fifo:out_data -> nios2_gen2_debug_mem_slave_agent:rf_sink_data
	...
	wire  [95:0] cmd_mux_003_src_data;                                                             // cmd_mux_003:src_data -> nios2_gen2_debug_mem_slave_agent:cp_data
	wire         cmd_mux_003_src_ready;                                                            // nios2_gen2_debug_mem_slave_agent:cp_ready -> cmd_mux_003:src_ready
	wire   [5:0] cmd_mux_003_src_channel;                                                          // cmd_mux_003:src_channel -> nios2_gen2_debug_mem_slave_agent:cp_channel
	...
	wire  [96:0] onchip_ram_s1_agent_rf_source_data;                                               // onchip_ram_s1_agent:rf_source_data -> onchip_ram_s1_agent_rsp_fifo:in_data
	...
	wire  [96:0] onchip_ram_s1_agent_rsp_fifo_out_data;                                            // onchip_ram_s1_agent_rsp_fifo:out_data -> onchip_ram_s1_agent:rf_sink_data
	...
	wire  [95:0] cmd_mux_004_src_data;                                                             // cmd_mux_004:src_data -> onchip_ram_s1_agent:cp_data
	wire         cmd_mux_004_src_ready;                                                            // onchip_ram_s1_agent:cp_ready -> cmd_mux_004:src_ready
	wire   [5:0] cmd_mux_004_src_channel;                                                          // cmd_mux_004:src_channel -> onchip_ram_s1_agent:cp_channel
	...
	wire  [95:0] nios2_gen2_data_master_agent_cp_data;                                             // nios2_gen2_data_master_agent:cp_data -> router:sink_data
	...
	wire  [95:0] nios2_gen2_instruction_master_agent_cp_data;                                      // nios2_gen2_instruction_master_agent:cp_data -> router_001:sink_data
	...
	wire         sd_card_avalon_sdcard_slave_agent_rp_valid;                                       // sd_card_avalon_sdcard_slave_agent:rp_valid -> router_003:sink_valid
	wire  [95:0] sd_card_avalon_sdcard_slave_agent_rp_data;                                        // sd_card_avalon_sdcard_slave_agent:rp_data -> router_003:sink_data
	wire         sd_card_avalon_sdcard_slave_agent_rp_ready;                                       // router_003:sink_ready -> sd_card_avalon_sdcard_slave_agent:rp_ready
	wire         sd_card_avalon_sdcard_slave_agent_rp_startofpacket;                               // sd_card_avalon_sdcard_slave_agent:rp_startofpacket -> router_003:sink_startofpacket
	wire         sd_card_avalon_sdcard_slave_agent_rp_endofpacket;                                 // sd_card_avalon_sdcard_slave_agent:rp_endofpacket -> router_003:sink_endofpacket
	...
	wire  [95:0] sysid_control_slave_agent_rp_data;                                                // sysid_control_slave_agent:rp_data -> router_004:sink_data
	...
	wire  [95:0] nios2_gen2_debug_mem_slave_agent_rp_data;                                         // nios2_gen2_debug_mem_slave_agent:rp_data -> router_005:sink_data
	...
	wire  [95:0] onchip_ram_s1_agent_rp_data;                                                      // onchip_ram_s1_agent:rp_data -> router_006:sink_data
	...
	wire  [95:0] router_src_data;                                                                  // router:src_data -> nios2_gen2_data_master_limiter:cmd_sink_data
	wire         router_src_ready;                                                                 // nios2_gen2_data_master_limiter:cmd_sink_ready -> router:src_ready
	wire   [5:0] router_src_channel;                                                               // router:src_channel -> nios2_gen2_data_master_limiter:cmd_sink_channel
	...
	wire  [95:0] nios2_gen2_data_master_limiter_cmd_src_data;                                      // nios2_gen2_data_master_limiter:cmd_src_data -> cmd_demux:sink_data
	wire         nios2_gen2_data_master_limiter_cmd_src_ready;                                     // cmd_demux:sink_ready -> nios2_gen2_data_master_limiter:cmd_src_ready
	wire   [5:0] nios2_gen2_data_master_limiter_cmd_src_channel;                                   // nios2_gen2_data_master_limiter:cmd_src_channel -> cmd_demux:sink_channel
	...
	wire  [95:0] rsp_mux_src_data;                                                                 // rsp_mux:src_data -> nios2_gen2_data_master_limiter:rsp_sink_data
	wire         rsp_mux_src_ready;                                                                // nios2_gen2_data_master_limiter:rsp_sink_ready -> rsp_mux:src_ready
	wire   [5:0] rsp_mux_src_channel;                                                              // rsp_mux:src_channel -> nios2_gen2_data_master_limiter:rsp_sink_channel
	...
	wire  [95:0] nios2_gen2_data_master_limiter_rsp_src_data;                                      // nios2_gen2_data_master_limiter:rsp_src_data -> nios2_gen2_data_master_agent:rp_data
	...
	wire   [5:0] nios2_gen2_data_master_limiter_rsp_src_channel;                                   // nios2_gen2_data_master_limiter:rsp_src_channel -> nios2_gen2_data_master_agent:rp_channel
	...
	wire  [95:0] router_001_src_data;                                                              // router_001:src_data -> nios2_gen2_instruction_master_limiter:cmd_sink_data
	wire         router_001_src_ready;                                                             // nios2_gen2_instruction_master_limiter:cmd_sink_ready -> router_001:src_ready
	wire   [5:0] router_001_src_channel;                                                           // router_001:src_channel -> nios2_gen2_instruction_master_limiter:cmd_sink_channel
	...
	wire  [95:0] nios2_gen2_instruction_master_limiter_cmd_src_data;                               // nios2_gen2_instruction_master_limiter:cmd_src_data -> cmd_demux_001:sink_data
	...
	wire   [5:0] nios2_gen2_instruction_master_limiter_cmd_src_channel;                            // nios2_gen2_instruction_master_limiter:cmd_src_channel -> cmd_demux_001:sink_channel
	...
	wire  [95:0] rsp_mux_001_src_data;                                                             // rsp_mux_001:src_data -> nios2_gen2_instruction_master_limiter:rsp_sink_data
	wire         rsp_mux_001_src_ready;                                                            // nios2_gen2_instruction_master_limiter:rsp_sink_ready -> rsp_mux_001:src_ready
	wire   [5:0] rsp_mux_001_src_channel;                                                          // rsp_mux_001:src_channel -> nios2_gen2_instruction_master_limiter:rsp_sink_channel
	...
	wire  [95:0] nios2_gen2_instruction_master_limiter_rsp_src_data;                               // nios2_gen2_instruction_master_limiter:rsp_src_data -> nios2_gen2_instruction_master_agent:rp_data
	...
	wire   [5:0] nios2_gen2_instruction_master_limiter_rsp_src_channel;                            // nios2_gen2_instruction_master_limiter:rsp_src_channel -> nios2_gen2_instruction_master_agent:rp_channel
	...
	wire   [5:0] nios2_gen2_data_master_limiter_cmd_valid_data;                                    // nios2_gen2_data_master_limiter:cmd_src_valid -> cmd_demux:sink_valid
	wire   [5:0] nios2_gen2_instruction_master_limiter_cmd_valid_data;                             // nios2_gen2_instruction_master_limiter:cmd_src_valid -> cmd_demux_001:sink_valid
