...
module Qsys_system_mm_interconnect_0 (
	...
	wire    [8:0] rsp_mux_src_channel;                                                                         // rsp_mux:src_channel -> pixel_buffer_dma_avalon_pixel_dma_master_agent:rp_channel
	...
	wire    [8:0] cmd_mux_001_src_channel;                                                                     // cmd_mux_001:src_channel -> pixel_buffer_dma_avalon_control_slave_agent:cp_channel
	...
	wire    [8:0] cmd_mux_003_src_channel;                                                                     // cmd_mux_003:src_channel -> sd_card_avalon_sdcard_slave_agent:cp_channel
	...
	wire    [8:0] cmd_mux_004_src_channel;                                                                     // cmd_mux_004:src_channel -> sysid_control_slave_agent:cp_channel
	...
	wire    [8:0] cmd_mux_005_src_channel;                                                                     // cmd_mux_005:src_channel -> nios2_gen2_debug_mem_slave_agent:cp_channel
	...
	wire    [8:0] cmd_mux_006_src_channel;                                                                     // cmd_mux_006:src_channel -> altpll_pll_slave_agent:cp_channel
	...
	wire    [8:0] cmd_mux_007_src_channel;                                                                     // cmd_mux_007:src_channel -> sdram_s1_agent:cp_channel
	...
	wire    [8:0] router_001_src_channel;                                                                      // router_001:src_channel -> nios2_gen2_data_master_limiter:cmd_sink_channel
	...
	wire    [8:0] nios2_gen2_data_master_limiter_cmd_src_channel;                                              // nios2_gen2_data_master_limiter:cmd_src_channel -> cmd_demux_001:sink_channel
	...
	wire    [8:0] rsp_mux_001_src_channel;                                                                     // rsp_mux_001:src_channel -> nios2_gen2_data_master_limiter:rsp_sink_channel
	...
	wire    [8:0] nios2_gen2_data_master_limiter_rsp_src_channel;                                              // nios2_gen2_data_master_limiter:rsp_src_channel -> nios2_gen2_data_master_agent:rp_channel
	...
	wire    [8:0] router_002_src_channel;                                                                      // router_002:src_channel -> nios2_gen2_instruction_master_limiter:cmd_sink_channel
	...
	wire    [8:0] nios2_gen2_instruction_master_limiter_cmd_src_channel;                                       // nios2_gen2_instruction_master_limiter:cmd_src_channel -> cmd_demux_002:sink_channel
	...
	wire    [8:0] rsp_mux_002_src_channel;                                                                     // rsp_mux_002:src_channel -> nios2_gen2_instruction_master_limiter:rsp_sink_channel
	...
	wire    [8:0] nios2_gen2_instruction_master_limiter_rsp_src_channel;                                       // nios2_gen2_instruction_master_limiter:rsp_src_channel -> nios2_gen2_instruction_master_agent:rp_channel
	...
	wire    [8:0] router_003_src_channel;                                                                      // router_003:src_channel -> pixel_buffer_avalon_sram_slave_rsp_width_adapter:in_channel
	...
	wire    [8:0] pixel_buffer_avalon_sram_slave_rsp_width_adapter_src_channel;                                // pixel_buffer_avalon_sram_slave_rsp_width_adapter:out_channel -> rsp_demux:sink_channel
	...
	wire    [8:0] cmd_mux_src_channel;                                                                         // cmd_mux:src_channel -> pixel_buffer_avalon_sram_slave_cmd_width_adapter:in_channel
	...
	wire    [8:0] pixel_buffer_avalon_sram_slave_cmd_width_adapter_src_channel;                                // pixel_buffer_avalon_sram_slave_cmd_width_adapter:out_channel -> pixel_buffer_avalon_sram_slave_burst_adapter:sink0_channel
	...
	wire    [8:0] nios2_gen2_data_master_limiter_cmd_valid_data;                                               // nios2_gen2_data_master_limiter:cmd_src_valid -> cmd_demux_001:sink_valid
	wire    [8:0] nios2_gen2_instruction_master_limiter_cmd_valid_data;                                        // nios2_gen2_instruction_master_limiter:cmd_src_valid -> cmd_demux_002:sink_valid
