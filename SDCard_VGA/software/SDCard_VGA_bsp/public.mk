...
# setting SOPC_SYSID_BASE_ADDRESS is 0x201440
SOPC_SYSID_FLAG += --sidp=0x201440
ELF_PATCH_FLAG  += --sidp 0x201440

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1509003872
SOPC_SYSID_FLAG += --timestamp=1509003872
ELF_PATCH_FLAG  += --timestamp 1509003872
