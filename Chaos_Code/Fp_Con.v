...
module  Fp_Con_altbarrel_shift_20g
	( 
	aclr,
	clk_en,
	clock,
...
endmodule //Fp_Con_altbarrel_shift_20g

//synthesis_resources = lpm_add_sub 5 lpm_compare 4 reg 281 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  Fp_Con_altfp_convert_l1n
	( 
	clock,
	dataa,
	result) ;
	...
	Fp_Con_altbarrel_shift_20g   altbarrel_shift6
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
...
endmodule //Fp_Con_altfp_convert_l1n
//VALID FILE
...
module Fp_Con (
	...
	Fp_Con_altfp_convert_l1n	Fp_Con_altfp_convert_l1n_component (
				.clock (clock),
				.dataa (dataa),
				.result (sub_wire0));
