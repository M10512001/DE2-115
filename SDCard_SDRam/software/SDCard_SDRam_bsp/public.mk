...
# setting SOPC_SYSID_BASE_ADDRESS is 0x10001438
SOPC_SYSID_FLAG += --sidp=0x10001438
ELF_PATCH_FLAG  += --sidp 0x10001438

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1508998657
SOPC_SYSID_FLAG += --timestamp=1508998657
ELF_PATCH_FLAG  += --timestamp 1508998657
