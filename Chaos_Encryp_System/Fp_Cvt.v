...
//altfp_convert CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Cyclone IV E" OPERATION="FLOAT2INT" ROUNDING="TO_NEAREST" WIDTH_DATA=32 WIDTH_EXP_INPUT=8 WIDTH_EXP_OUTPUT=8 WIDTH_INT=32 WIDTH_MAN_INPUT=23 WIDTH_MAN_OUTPUT=23 WIDTH_RESULT=32 clock dataa result
...
module  Fp_Cvt_altbarrel_shift_20g
	( 
	aclr,
	clk_en,
	clock,
...
endmodule //Fp_Cvt_altbarrel_shift_20g

//synthesis_resources = lpm_add_sub 5 lpm_compare 4 reg 281 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  Fp_Cvt_altfp_convert_l1n
	( 
	clock,
	dataa,
	result) ;
	...
	Fp_Cvt_altbarrel_shift_20g   altbarrel_shift6
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
...
endmodule //Fp_Cvt_altfp_convert_l1n
//VALID FILE
...
module Fp_Cvt (
	...
	Fp_Cvt_altfp_convert_l1n	Fp_Cvt_altfp_convert_l1n_component (
				.clock (clock),
				.dataa (dataa),
				.result (sub_wire0));
